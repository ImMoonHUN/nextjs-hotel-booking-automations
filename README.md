...
This is a professional, concept-stage automated booking system for a fictional luxury guesthouse, **Lumina House**. It features a modern, high-end "Dark Luxury" UI and fully integrated simulated background automations.
...
- **Automations Demo Dashboard:** A live, integrated terminal UI that visually tracks the background automation steps as they happen.
- **Real-Time Ethereal Email Integration:** The backend dynamically generates a testing SMTP account and sends a beautifully formatted HTML confirmation email containing the user's details and selected room.
...
- [Vanilla CSS Modules](https://github.com/css-modules/css-modules) - Styling & Design System
- [Nodemailer](https://nodemailer.com/) & [Ethereal](https://ethereal.email/) - Email Automations
